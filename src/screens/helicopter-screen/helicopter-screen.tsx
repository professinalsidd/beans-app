...
export const HelicopterScreen = () => {
  ...
  const handleSubmit = () => {
    setLoading(true);
    Services.helicopter(inputForm, inputForm2)
      .then((res: any) => {
    ...
    <Fragment>
      <View style={SINGLE_INPUT_STYLE.container}>
        <View style={SINGLE_INPUT_STYLE.subContainer}>
          <TextInputComponent
            placeHolderName="Enter helicopter manufacturer company name"
          ...
          <TextInputComponent
            placeHolderName="Enter helicopter model"
            placeHolderTextColor="#000"
            onChangeText={(text: React.SetStateAction<string>) =>
              setInputForm2(text)
            }
