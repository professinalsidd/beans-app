...
export const DictionaryScreen = () => {
  ...
  const handleSubmit = () => {
    setLoading(true);
    Axios.get(`https://api.api-ninjas.com/v1/dictionary?word=${inputForm}`)
      .then((res) => {
    ...
    <Fragment>
      ...
      <View style={SINGLE_INPUT_STYLE.container}>
        <View style={SINGLE_INPUT_STYLE.subContainer}>
          <TextInputComponent
            placeHolderName="Enter any words"
              ...
              <View style={SINGLE_INPUT_STYLE.mainContainer}>
                <View style={SINGLE_INPUT_STYLE.singleCardContainer}>
                  <Text style={SINGLE_INPUT_STYLE.singleCardContainerText}>
                    word:- {showResult && showResult?.word}
                  </Text>
                </View>
                <View style={SINGLE_INPUT_STYLE.singleCardContainer}>
                  <Text style={SINGLE_INPUT_STYLE.singleCardContainerText}>
                    definition:- {showResult && showResult?.definition}
                  </Text>
                </View>
              </View>
            </ScrollView>
